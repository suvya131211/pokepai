...
func _pallet_town() -> Dictionary:
	...
	return _make_area("Pallet Town", "town", w, h, rows, {
		...
		"npcs": [
			...
			{"x": 15, "y": 26, "name": "Fisherman", "type": "npc", "dialog": ["The lake here is great for fishing!", "Press E while facing water to fish.", "You might find Squirtle or Magikarp!"]},
			{"x": 25, "y": 15, "name": "Old Lady", "type": "npc", "dialog": ["Take care on your journey, dear!", "Remember to heal your Pokemon at Pokemon Centers.", "The pink dot on your map shows Nurse Joy!"]},
...
func _pewter_city() -> Dictionary:
	...
	return _make_area("Pewter City", "town", w, h, rows, {
		...
		"npcs": [
			...
			{"x": 15, "y": 12, "name": "Move Tutor", "type": "move_tutor", "dialog": ["I can teach your Pokemon a powerful move!", "Come back when you have more badges."]},
			{"x": 10, "y": 8, "name": "Hiker", "type": "npc", "dialog": ["Mt. Moon is east of here. Lots of rare Pokemon!", "Watch out for Team Shadow in the caves!", "Bring plenty of Pokeballs and Potions!"]},
...
func _cerulean_city() -> Dictionary:
	...
	return _make_area("Cerulean City", "town", w, h, rows, {
		...
		"npcs": [
			...
			{"x": 12, "y": 14, "name": "Swimmer", "type": "npc", "dialog": ["The lake here is full of Water Pokemon!", "Try fishing for rare catches!", "Psyduck and Horsea love this lake."]},
			{"x": 25, "y": 8, "name": "Kid", "type": "npc", "dialog": ["I saw a shiny Pokemon once! It had a golden glow!", "They're super rare — like 1 in 500!", "If you see a star next to a Pokemon, that means it's shiny!"]},
...
func _vermilion_city() -> Dictionary:
	...
	return _make_area("Vermilion City", "town", w, h, rows, {
		...
		"npcs": [
			...
			{"x": 12, "y": 12, "name": "Sailor", "type": "npc", "dialog": ["Welcome to the port city!", "Ships from all over dock here.", "Lt. Surge used to be in the military. His Pokemon are tough!"]},
			{"x": 28, "y": 5, "name": "Trader", "type": "npc", "dialog": ["I collect rare Pokemon!", "If you catch all 50 species, come talk to me!", "I hear there's an Eevee hiding near Pallet Town..."]},
...
func _saffron_city() -> Dictionary:
	...
	return _make_area("Saffron City", "town", w, h, rows, {
		...
		"npcs": [
			...
			{"x": 20, "y": 18, "name": "Scientist", "type": "npc", "dialog": ["Silph Co. was working on a device to track Pokemon abilities.", "Each Pokemon species has a unique ability!", "Press C to check your Pokemon's ability and nature."]},
...
func _pokemon_league() -> Dictionary:
	...
	return _make_area("Pokemon League", "league", w, h, rows, {
		...
		"npcs": [
			...
			{"x": 8, "y": 15, "name": "Veteran", "type": "npc", "dialog": ["The Elite Four are the strongest trainers in the region.", "You'll fight Lorelei, Bruno, Agatha, and Lance in sequence.", "Make sure ALL your Pokemon are healed before you start!", "After the Elite Four, you face the Champion... your rival."]},
