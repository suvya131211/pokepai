...
func _celadon_city() -> Dictionary:
	...
	return _make_area("Celadon City", "town", 30, 20, rows, {
		...
		"npcs": [
			...
			{"x": 5, "y": 12, "name": "Koga", "type": "gym_leader_2", "specialty": "poison", "badge": "Soul Badge",
...
func _saffron_city() -> Dictionary:
	...
	return _make_area("Saffron City", "town", 30, 20, rows, {
		...
		"npcs": [
			...
			{"x": 5, "y": 12, "name": "Blaine", "type": "gym_leader_2", "specialty": "fire", "badge": "Volcano Badge",
			...
			{"x": 16, "y": 12, "name": "Giovanni", "type": "gym_leader_2", "specialty": "ground", "badge": "Earth Badge",
