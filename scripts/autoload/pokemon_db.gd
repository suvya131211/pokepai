...
var species: Array[Dictionary] = [
	{"id":1,  "name":"Bulbasaur",  "sprite":"res://assets/sprites/1.png",   "type":"grass",    "pokeapi":1,   "color":Color("#66bb6a"), "hp":45, "atk":49, "def":49, "rarity":1, "habitats":["grass","tall_grass","forest"], "evolves_to":null, "ability":"Overgrow"},
	{"id":2,  "name":"Charmander", "sprite":"res://assets/sprites/4.png",   "type":"fire",     "pokeapi":4,   "color":Color("#ef5350"), "hp":39, "atk":52, "def":43, "rarity":1, "habitats":["sand","cave"], "evolves_to":16, "evolve_level":16, "ability":"Blaze"},
	{"id":3,  "name":"Squirtle",   "sprite":"res://assets/sprites/7.png",   "type":"water",    "pokeapi":7,   "color":Color("#42a5f5"), "hp":44, "atk":48, "def":65, "rarity":1, "habitats":["sand","beach"], "evolves_to":17, "evolve_level":18, "ability":"Torrent"},
